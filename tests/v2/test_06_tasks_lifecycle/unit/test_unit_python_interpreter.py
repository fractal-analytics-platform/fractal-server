...
async def test_get_python_interpreter_v2(
    ...
    override_settings_factory(
        ...
        FRACTAL_TASKS_PYTHON_3_9_zzz=MOCK_PYTHON_3_9,
        FRACTAL_TASKS_PYTHON_3_10_zzz=None,
        FRACTAL_TASKS_PYTHON_3_11_zzz=None,
        FRACTAL_TASKS_PYTHON_3_12_zzz=MOCK_PYTHON_3_12,
    )
