...
\restrict X7Dqvg69ByrD5bsCXybyELR2Syk5NGCMk3pfUir9vgVvUio1H6E0TtoqtX7J9x9
...
2	admin_project	2026-03-26 17:05:53.240824+01	1
\.
...
28	vanilla@example.org	$2b$12$MhcmYFfmLP4oIDzQ.jbcJuLoUvpJ73B92LrWPp6k3eh7e6xP/0Gs2	t	f	t	1	{}	{/placeholder}	f
\.
...
5	3	0	null	null	null	null	non_parallel	2	{}	\N	\N
6	4	0	null	null	null	null	non_parallel	2	{}	\N	\N
\.
...
2	28	MyTemplate	1	2.20.3	2026-03-26 17:07:25.96073+01	2026-03-26 17:07:57.410222+01	1	test template	{"name": "NewWorkflow", "description": null, "task_list": [{"meta_non_parallel": null, "meta_parallel": null, "args_non_parallel": null, "args_parallel": null, "type_filters": {}, "description": null, "alias": null, "task": {"pkg_name": "admin:ls-task", "version": "1.0.0", "name": "Ls Task"}}]}
\.
...
3	NewWorkflow	1	2026-03-26 17:06:55.456725+01	\N	\N
4	NewWorkflow	2	2026-03-26 17:07:57.390344+01	\N	2
\.
...
SELECT pg_catalog.setval('public.workflowtaskv2_id_seq', 6, true);
...
SELECT pg_catalog.setval('public.workflowtemplate_id_seq', 2, true);
...
SELECT pg_catalog.setval('public.workflowv2_id_seq', 4, true);
...
\unrestrict X7Dqvg69ByrD5bsCXybyELR2Syk5NGCMk3pfUir9vgVvUio1H6E0TtoqtX7J9x9
