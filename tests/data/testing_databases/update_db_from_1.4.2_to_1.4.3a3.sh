...
INPUT_DUMP=clean_db_fractal_1.4.2.sql
OUPUT_DUMP=clean_db_fractal_1.4.3a3.sql
...
# v1.4.0 SETUP
VENV_NAME=venv_1_4_2
python3 -m venv $VENV_NAME
source ${VENV_NAME}/bin/activate
python3 -m pip install fractal-server[postgres]==1.4.2
# v1.4.0 ACTIVITY
fractalctl set-db
# v1.4.0 TEARDOWN
deactivate
...
# v1.4.3 SETUP
VENV_NAME=venv_1_4_3a3
python3 -m venv $VENV_NAME
source ${VENV_NAME}/bin/activate
python3 -m pip install fractal-server[postgres]==1.4.3a3
# v1.4.1 ACTIVITY
fractalctl set-db
# v1.4.1 TEARDOWN
deactivate
