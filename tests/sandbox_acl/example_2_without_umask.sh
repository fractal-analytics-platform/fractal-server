...
# Set ACL for $DIR
as_user testuser1 "umask 0002 && setfacl -b $DIR"
as_user testuser1 "umask 0002 && setfacl --modify user:testuser1:rwx,user:testuser2:rwx,group::---,other::--- $DIR"
as_user testuser1 "umask 0002 && setfacl --default --modify user:testuser1:rwx,user:testuser2:rwx,group::---,other::--- $DIR"
as_user testuser1 "umask 0002 && getfacl -p $DIR"
echo
