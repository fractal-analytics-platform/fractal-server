...
* API
    ...
    * Add `GET /api/v2/task-group/activity/` endpoint (\#2005, \#2027).
    * Add `POST /api/v2/task-group/{task_group_id}/{deactivate|reactivate}` endpoint (\#2033, \#2066).
    * Add `POST /admin/v2/task-group/{task_group_id}/{deactivate|reactivate}` endpoint (\#2062).
