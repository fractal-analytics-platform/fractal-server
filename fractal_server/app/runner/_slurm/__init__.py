...
async def process_workflow(
    *,
    ...
    output_dataset_metadata = await async_wrap(_process_workflow)(workflow=workflow, input_paths=input_paths, output_path=output_path, input_metadata=input_metadata, logger_name=logger_name, workflow_dir=workflow_dir, username=username, worker_init=worker_init)
...
def _process_workflow(
    *,
    ...
    logger.debug("START CFUT")

    #with ThreadPoolExecutor() as executor:
    with cfut.SlurmExecutor(debug=True, keep_logs=True, additional_setup_lines=("#SBATCH --partition=main",)) as executor:
