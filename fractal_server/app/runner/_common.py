...
def set_job_logger(
    job: ApplyWorkflow, level: int = logging.warning, logger_name: str = None
) -> logging.Logger:

    log_path = job.job_dir_path / "workflow.log"

    logger = logging.getLogger(logger_name or f"job{job.id}")
