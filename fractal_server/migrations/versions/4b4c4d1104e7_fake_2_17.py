...
Revision ID: 4b4c4d1104e7
Revises: 981d588fe248
Create Date: 2025-11-20 09:15:49.872912
...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        sa.Column(
            "jobs_local_dir", sqlmodel.sql.sqltypes.AutoString(), nullable=False
        ),
        sa.Column(
            "jobs_runner_config",
    ...
    op.create_table(
        ...
        sa.Column(
            "jobs_remote_dir", sqlmodel.sql.sqltypes.AutoString(), nullable=True
        ),
        sa.Column(
            "tasks_remote_dir",
            sqlmodel.sql.sqltypes.AutoString(),
