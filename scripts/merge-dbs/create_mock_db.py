...
if __name__ == "__main__":
    ...
    user = _user_flow_vanilla(admin, working_task_id=working_task.id)
    new_group = admin.add_user_group()
    new_group_with_user = admin.add_user_usergroup(
        group_id=new_group.id, user_id=user.id
    )
    # _user_flow_power(
    #     admin, working_task_id=working_task.id,
    #   failing_task_id=failing_task.id
    # )
